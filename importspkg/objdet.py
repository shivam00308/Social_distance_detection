from .global_var import NMS_THRESH
from .global_var import MIN_CONF
import numpy as np
import cv2

def detect_people(frame, net, ln, personIdx=0, carIdx =2):
	...
	for output in layerOutputs:
		...
		for detection in output:
			...
			#same if condition for detecting cars in the image.
